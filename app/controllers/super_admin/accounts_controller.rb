class SuperAdmin::AccountsController < SuperAdmin::ApplicationController
  ...
  def seed
    ...
    redirect_back(fallback_location: [namespace, requested_resource], notice: 'Geração de dados de exemplo da conta iniciada')
  ...
  def reset_cache
    ...
    # rubocop:disable Rails/I18nLocaleTexts
    redirect_back(fallback_location: [namespace, requested_resource], notice: 'Chaves de cache limpas')
    # rubocop:enable Rails/I18nLocaleTexts
  end
